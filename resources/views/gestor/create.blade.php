    ...
    <div class="col-md-9 offset-md-1">
        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <div class="container">
                    <form action="{{ route('gestor.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="email-input" name="nome" placeholder="Enter Email" class="form-control" value="{{ old('nome') ? old('nome') : '' }}">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="password-input" name="telefone" placeholder="telefone" class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="password-input" name="residencia" placeholder="residencia" class="form-control">
